...
echo ******** description: ********
echo.
echo clpr.bat will Complile your program, Link it, Program the target, and Run the 
echo newly built program on the target.  clpr.bat is designed to be low-maintenance
echo so that updates can be made to the real script (..\common\clpr_CM.bat) without
echo having to update clpr.bat in every project directory.  See clpr_CM.bat for more
echo info
echo.
echo.
echo ******** general usage: ********
...
:end
echo CLPR.BAT INFO: clpr.bat just finished